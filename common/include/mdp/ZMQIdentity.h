...
public:
    ...
    friend bool operator==(const ZMQIdentity &x, const ZMQIdentity &y)
    {
    ...
    static ZMQIdentity unique() { return ZMQIdentity{uniqueId()}; }
};

inline bool operator!=(const ZMQIdentity &x, const ZMQIdentity &y)
{
    return !(x == y);
}
