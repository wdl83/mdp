...
inline MDP::MessageHandle recv(zmqpp::socket &socket, IOMode ioMode)
{
...
inline void send(zmqpp::socket &socket, MDP::Message message, IOMode ioMode)
{
    const auto status
